...
/**
 * This class represents a User in the Urban Parks System. A Park Manager will
 * be able to check the length of the job and how far away the job is.
 * 
 * @author Deepjot Kaur
...
public class ParkManager extends User implements Serializable {
	...
	/**
	 * precondition: No job can be specified that takes more than the
	 * maximum number of days.
	 * 
	 * postcondition: true if the job will take under max specified days,
	 * false otherwise.
	 */
	...
	/**
	 * precondition: No job can be maximum days into the future.
	 * 
     * postcondition: false is returned if it is over max days away,

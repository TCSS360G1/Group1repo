...
public class Volunteer extends User implements Serializable {
	...
	public static boolean identifyVolunteer(User theVolunteer) {
		boolean isVolunteer = false;
		
		if (theVolunteer.getType().equals("Volunteer")) {
			System.out.print("\n-Welcome, Volunteer: "
					+ theVolunteer.getFirstName() + " "
					+ theVolunteer.getLastName() + "\n");
			isVolunteer = true;
		}
	 ...
	 * @param theCandidate
	 * 
	 *            A job that has a potential conflicting start and end
	 * 
	 * 
	 * 
	 *            date.
	 ...
	 * @param theCandidate
	 * 
	 *            The job the volunteer would like to sign up for.
	 * 
	 * 
	 * 
	 ...
	 * @param theJob
	 * 
	 *            A job that may already be in the current jobs.
	 * 
	 * 
	 * 
	 * @throws exceptions
	 * 
	 *             based on what failed in adding the job.
	 * 
	 * 
	 * 
	 */

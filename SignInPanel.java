...
//		}
    		...
    		for(int i = 0; i<theUsers.getSize(); i++) {
    			...
    			if (theUsers.getIndex(i).getName().toLowerCase().equals(name.toLowerCase())) {
    				...
    				if(theUsers.getIndex(i).getType().equals("Manager")) {
    					...
    					ParkManagerPanel managerPanel = new ParkManagerPanel(manager, currentJobs);
    					...
    					VolunteerPanel volunteerPanel = new VolunteerPanel(volunteer, theJobs);
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (evt.getPropertyName().equals("Manager add")) {
			...
			//			System.out.println(
			//					myJobs.getSize() + "  " + manager.getJobs().size());
			firePropertyChange("Manager add", evt.getOldValue(), evt.getNewValue());
			...
			firePropertyChange("Manager remove", evt.getOldValue(), evt.getNewValue());
			}
		}
...
//    			if (theUsers.getIndex(i).getName().toLowerCase().equals(name.toLowerCase())) {
//    				
//    				//ArrayList<Job> currentJobs = myJobs.filterPast();
//    				userFound = true;
//    				System.out.println("-Found a User-");
//    				if(theUsers.getIndex(i).getType().equals("Manager")) {
//    					// TODO: Go to Park Manager

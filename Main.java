...
//	private static ParkManager dk = new ParkManager("Deepjot", "Kaur");
//	private static ParkManager lm = new ParkManager("Luke", "Manca");
//	private static Volunteer jv = new Volunteer("Jenzel", "Villanueva");
//	private static Volunteer ks = new Volunteer("Kai", "Stansfield");
//	private static UrbanParksEmployee deepjot = new UrbanParksEmployee(
//			"Deepjot", "K");
...
//		fillCollections();
					...
					//		myUsers.add(dk);
					//		dk.addJob(new Job("Seattle Center", "Seattle", "Clean up after event",
					//				LocalDate.of(2018, 3, 10), LocalDate.of(2018, 3, 10)));
					//		myUsers.add(lm);
					//		myUsers.add(ks);
					//		myUsers.add(jv);
					//		myUsers.add(deepjot);
					//		myJobs.addNewJob(new Job("Seattle Center", "Seattle", "Clean up after event",
					//				LocalDate.of(2018, 3, 10), LocalDate.of(2018, 3, 10)));
		
		//System.out.println(myUsers.getSize());

...
public class Job implements Serializable {
	...
	/**
	 * The constructor for a Job, containing its title, description, location,
	 * start date, and end date.
	 * 
	 * @param theTitle
	 *            the title given to the Job.
	 * @param theDescription
	 *            the description explaining the Job details.
	 * @param theLocation
	 *            the location of which the Job takes place.
	 * @param theStartDate
	 *            the date that the Job starts at.
	 * @param theEndDate
	 *            the date that the Job ends at.
	 */

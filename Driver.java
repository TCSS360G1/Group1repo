...
//			System.out.flush();
	...
	public static void showParkManagerMenu(ParkManager theManager, 
		...
		System.out.println("3. Sign Out of account.");
		System.out.println("4. Unsubmit a Job.");
		...
		if (choice.equals("1")) {
			...
			System.out.println();
			System.out.println("Enter the Title of the Job you would like to remove:");
			String removeTitle = user.nextLine();
			removeJob(theManager, removeTitle, theJobs);
//			showParkManagerMenu(theManager, theUsers, theJobs);
		}
	...
	public static void removeJob(ParkManager theManager, String theTitle, ArrayList<Job> theJobList){
//		ArrayList<Job> filled_data_ = new ArrayList<>();
		for (Job accessedJob : theJobList) {
			if (accessedJob.getTitle() == theTitle){
				if(theManager.isJobTooSoonToCancel(accessedJob.getStartDate())){
					System.out.println("Job too soon to be removed");
					
				}else{
					theJobList.remove(accessedJob);

...
public class VolunteerAvailableJobsPanel extends JPanel {
    ...
    /**
     * precondition: myAvailableJobs != null and myJobs != null.
     * 
     * postcondition: Sets up the VolunteerAvailableJobs panel.
     */
    private void setupPanel() {
        this.setBorder(BorderFactory.createTitledBorder("All jobs that are"
        		+ " available"));
    ...
    /**
	 * precondition: myAvailableJobs != null && myJobs != null
	 * && myVolunteer != null.
	 * 
	 * postcondition: Display all of the current available Jobs.
	 */
	private void displayAvailableJobs(ArrayList<Job> theJobs) {
		JButton add = new JButton("Sign Up");
		ButtonGroup BG = new ButtonGroup();
		for(int i=0; i<theJobs.size(); i++) {
			JRadioButton j = new JRadioButton((i+1) + ". "
		            + theJobs.get(i).toString());
			BG.add(j);

...
public class VolunteerMenuBar extends JMenuBar {
    ...
    /**
     * precondition: VolunteerMenuBar != null.
     * 
     * postcondition: Creates a "Current Jobs" button for the Volunteer Menu.
     */
     ...
     * precondition: VolunteerMenuBar != null.
     * 
     * postcondition: Creates a "Volunteer!" button for the Volunteer Menu.
     */
     ...
     * precondition: VolunteerMenuBar != null.
     * 
     * postcondition: Creates an "Unvolunteer" button for the Volunteer Menu.
     */
     ...
     * precondition: VolunteerMenuBar != null.
     * 
     * postcondition: Creates a "Sign Out" button for the Volunteer Menu.
     */

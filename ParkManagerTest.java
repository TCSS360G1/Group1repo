...
public class ParkManagerTest {
	...
	/*No myManager can remove a Job that starts within 3 days of current day*/
	/*test max number 3*/
	@Test
	public void isJobRemovable_inTheClear_false() {
		assertFalse(myManager.isJobTooSoonToCancel(LocalDate.of(2018, 3, 9)));
	}
	/*No myManager can remove a Job that starts within 3 days of current day*/
	/*test max number 3*/
	@Test
	public void isJobRemovable_4DaysLeft_false() {
		assertFalse(myManager.isJobTooSoonToCancel(LocalDate.of(2018, 2, 25)));
	}
	/*No myManager can remove a Job that starts within 3 days of current day*/
	/*test max number 3*/
	@Test
	public void isJobRemovable_3DaysLeft_true() {
		assertTrue(myManager.isJobTooSoonToCancel(LocalDate.of(2018, 2, 24)));
	}
	/*No myManager can remove a Job that starts within 3 days of current day*/
	/*test max number 3*/
	@Test
	public void isJobRemovable_1DayLeft_true() {
		assertTrue(myManager.isJobTooSoonToCancel(LocalDate.of(2018, 2, 22)));
	}
		
	/*No myManager can remove a Job that starts within 3 days of current day*/
	/*test day OF Job*/
	@Test
	public void isJobRemovable_today_true() {
		assertTrue(myManager.isJobTooSoonToCancel(LocalDate.now()));
	}
	
	/*No myManager can remove a Job that starts within 3 days of current day*/
	/*testing A job that was scheduled for yesterday*/
	@Test
	public void isJobRemovable_yesterdayJob_true() {
		assertTrue(myManager.isJobTooSoonToCancel(LocalDate.now().minusDays(1)));
	}
}
